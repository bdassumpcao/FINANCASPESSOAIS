...
public class DatabaseHelper extends SQLiteOpenHelper {
	...
	{		
		...
		db.execSQL("CREATE TABLE financas (_id INTEGER PRIMARY KEY, ds_historico TEXT, vl_despesa DOUBLE, vl_receita DOUBLE, ds_tipo TEXT, dt_lancamento DATE, cd_categoria INTEGER, cd_pagamento INTEGER,ds_situacao TEXT, dt_vencimento DATE); ");
